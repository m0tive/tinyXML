...
// ========== TiXmlOutStream member functions ==========

/// Put length chars from out to the output stream
void TiXmlOutStream::write (const char * out, int length)
{
   char * newstring;
